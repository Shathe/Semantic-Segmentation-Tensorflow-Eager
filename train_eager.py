...
if __name__ == "__main__":
    ...
    model = Segception.Segception_v2(num_classes=n_classes, weights='imagenet', input_shape=(None, None, channels))
    ...
    # Test best model
    print('Testing model')
    test_acc, test_miou = get_metrics(loader, model, loader.n_classes, train=False, flip_inference=True, scales=[0.75, 1, 1.5], write_images=True, preprocess_mode=preprocess_mode)
    print('Test accuracy: ' + str(test_acc.numpy()))
    print('Test miou: ' + str(test_miou))